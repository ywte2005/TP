        ...
        <div class="main">
            ...
            <table  cellpadding=3 cellspacing=3>
                <tr>
                    <td>
                        <div class="result">
                            当前URL路由到模块 <span style="color:red"><?php echo (MODULE_NAME); ?></span> 的<span style="color:red"><?php echo (ACTION_NAME); ?></span> 操作<br/>
                            参数:<br/>
                ...
                <tr>
                    <td class="tLeft" >
                        路由1：<a href="<?php echo U('/blog/curd');?>">blog/curd</a><br/>
                        路由2：<a href="<?php echo U('/blog/5');?>">blog/5</a><br/>
                        路由3：<a href="<?php echo U('/blog/2012/09');?>">blog/2012/09</a><br/>
                        路由4：<a href="<?php echo U('/100');?>">100</a><br/>
                    </td>
                </tr>
            </table>
        </div>
